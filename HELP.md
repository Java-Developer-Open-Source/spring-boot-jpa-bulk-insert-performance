...
* The original package name 'com.java.developer.spring-boot-jpa-bulk-insert-performance' is invalid and this project uses 'com.java.developer.springbootjpabulkinsertperformance' instead.
